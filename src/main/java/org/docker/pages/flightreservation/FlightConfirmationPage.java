...
public class FlightConfirmationPage extends AbstractPage {
    ...
    public String getPrice() {
        var confirmation = this.flightConfirmationElement.getText();
        var price = this.totalPriceElement.getText();
        log.info("Flight confirmation is {}", confirmation);
        log.info("Flight confirmation price is {}", price);
